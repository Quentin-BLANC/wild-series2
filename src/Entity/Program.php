 ...
 * // On précise à l'entité que nous utiliserons l'upload du package Vichuploader
 * @Vich\Uploadable
 */
class Program
{
     ...
     * @Assert\Length(max="255", maxMessage="Le nom du programme saisi {{ value }} est trop long, il ne devrait pas dépasser {{ limit }} caractères")
     */
    private $title;

    /**
     * @ORM\Column(type="text")
     * @Assert\NotBlank(message="c'est quoi les bails ?")
    ...
    // Tu peux d'ailleurs voir que l'annotation ORM column n'est pas spécifiée car on ne rajoute pas de données de type file en bdd
    /**
